...
public class CobolFieldPatternValidator {
    public static final String ALPHANUMERIC_PATTERN = "(?i)X+|X\\([1-9][0-9]*\\)";
    public static final String INTEGER_PATTERN = "(?i)9+|9\\([1-9][0-9]*\\)";
    public static final String DECIMAL_PATTERN = "(?i)9+v9+|9\\([1-9][0-9]*\\)v9+|9v9\\([1-9][0-9]*\\)|9\\([1-9][0-9]*\\)v9\\([1-9][0-9]*\\)";
