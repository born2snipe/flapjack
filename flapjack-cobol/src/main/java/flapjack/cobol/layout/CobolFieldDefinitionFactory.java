...
public class CobolFieldDefinitionFactory {
    private CobolFieldPatternValidator patternValidator = new CobolFieldPatternValidator();

    public CobolFieldDefinition build(String pattern) throws IllegalArgumentException {
        ...
        return new AlphaNumericFieldDefinition("", -1, pattern);
    }
}
